...
<div class="container" id="lamoon">
     ...
     <form  action="{{ url('/nisitinfos') }}" enctype="multipart/form-data" method="post" >
            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="hidden" name="idcard" value="{{Auth::user()->id_card}}" />
                        <input  type="text" class = "form-control" name="idcard" value="{{Auth::user()->id_card}}" disabled="disabled" />
                ...
                <div class="text-center">
                    ...
                    <a href =  "{{url('/nisitinfos')}}"><button type="button" class="btn btn-danger">ยกเลิก</button></a>
                </div>
                <br><br><br>
                </div>
            </form>
