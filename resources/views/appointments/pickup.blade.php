...
<form  action="{{ url('/informations/'.$Information->id.'/appointments') }}" enctype="multipart/form-data" method="post" >
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
<div class="container">
  <div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">ระบบจองเวลาเพื่อขอรับคำปรึกษา</h1>
    <!-- <p class="lead">ข้อมูลทั้งหมดถูกเก็บเป็นความลับ</p> -->
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$appoint->information->firstname}}  {{$appoint->information->lastname}}</td>
        ...
        <div class="row">
         ...
         <form action="https://formden.com/post/MlKtmY4x/" class="form-horizontal" method="post">
           ...
           <div class="container">
             <div class="row">
               <div class="col-sm">
               <button type="submit" class="btn btn-primary">ยืนยันการขอเข้ารับคำปรึกษา</button>
