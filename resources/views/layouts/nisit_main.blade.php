...
#home_right{
  float: right;
    ...
    <nav class="navbar navbar-expand navbar-light bg-light static-top">
      ...
      <a class="navbar-brand mr-1" href="{{url('/')}}"><img src="{{ url('images/KU_Logo.png') }}" alt="logo" style="width:45px;"></a>
      <!-- <a class="nav-item nav-link active" href="{{url('/nisitinfos')}}">ข้อมูลส่วนตัว</a> -->
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
       <!-- <li class="nav-item dropdown no-arrow mx-1">
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <a class="dropdown-item" href="{{url('/nisitinfos')}}" >{{Auth::user()->name}}</a>
    ...
    <!-- <div id="wrapper"> -->
      ...
      <!-- <ul class="sidebar navbar-nav  bg-ku">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/excel_list')}}">
            <i class="fa fa-calendar"></i>
            <span>รายงาน</span></a>
        </li>
      </ul> -->
